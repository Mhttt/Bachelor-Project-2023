...
const Header: Component = () => {
  ...
  if (access) {
    const username = jwt_decode<{ sub: string }>(access).sub;
  ...
  return (
    <header>
      <div class="text-icon">
        <A class="svg-button" href="/register">
          <svg version="1.1" x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" width="20px">
            <g>
              <path d="M497.3,703.9" />
      ...
      <A class="white-text shop-title" href="/">
        WEBSHOP
      </A>
      <div class="text-icon">
        <button class="svg-button">
          <svg fill="#000000" version="1.1" id="Capa_1" width="20px" viewBox="0 0 902.86 902.86">
            <g>
              <g>
                <path
